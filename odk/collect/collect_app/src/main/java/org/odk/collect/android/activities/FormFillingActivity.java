...
public class FormFillingActivity extends LocalizedActivity implements AnimationListener,
    ...
    private void initToolbar() {
        ...
        tvFormId.setTextColor(getColor(settingsProvider.getUnprotectedSettings().getString(ProjectKeys.FORM_ACTIVITY_TOOLBAR_FOREGROUND_COLOR)));
    }
    ...
    private SwipeHandler.View createView(int event, boolean advancingPage) {
        ...
        //FormId
        String formId = getIntent().getExtras().getString(ApplicationConstants.BundleKeys.FORM_ID);
        tvFormId.setText(formId);
