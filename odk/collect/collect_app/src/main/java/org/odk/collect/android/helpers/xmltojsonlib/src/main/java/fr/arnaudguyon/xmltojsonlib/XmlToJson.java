package org.odk.collect.android.helpers.xmltojsonlib.src.main.java.fr.arnaudguyon.xmltojsonlib;
/*
            ...
            do {
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    for (int i = 0; i < attrCount; ++i) {
                        ...
                        for (String key : mSkippedAttributes) {
                            if (attrPath.contains(key)) {
                                flagFound = true;
                                break;
                            }
                        }
