...
object RemoteConfigUtils {
    ...
    private val DEFAULTS: HashMap<String, Any> = hashMapOf(
        ...
        GEOFENCING_CONFIG to "{\"enabled\":true,\"actors_disabled\":[1],\"geofencing_initials\":{\"fencing_radius\":500},\"location_mismatch_error_dialog\":{\"title\":\"You are far from the school\",\"description\":\"You are outside the predefined geofence of the school.\"}}",
