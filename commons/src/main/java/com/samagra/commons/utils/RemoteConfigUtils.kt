...
object RemoteConfigUtils {
    ...
    const val AUTH_BASE_URL = "AUTH_BASE_URL"
    ...
    const val SYNC_INTERVAL_MINUTES_PER_ACTOR = "sync_interval_minutes_per_actor"
    ...
    const val IS_POSTHOG_ENABLED = "posthog_enabled"
    const val APP_ACTIONS_ALLOWED = "app_actions_allowed"
    ...
    private val DEFAULTS: HashMap<String, Any> = hashMapOf(
        ...
        AUTH_BASE_URL to BuildConfig.DEFAULT_AUTH_BASE_URL,
        ...
        SYNC_INTERVAL_MINUTES_PER_ACTOR to "{\"1\":15,\"2\":15,\"3\":360,\"4\":15,\"5\":15}",
        ...
        PARTNER_CODE to "upprerna",
        IS_POSTHOG_ENABLED to true,
        APP_ACTIONS_ALLOWED to "[DELETE,CLEAR]"
    )
