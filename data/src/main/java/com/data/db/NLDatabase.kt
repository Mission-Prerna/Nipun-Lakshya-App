...
@Database(
    entities = [
        ...
        MentorPerformanceInsightsItem::class,
        School::class,
...
abstract class NLDatabase : RoomDatabase() {
    ...
    abstract fun getMentorPerformanceInsightsDao(): MentorPerformanceInsightsDao

    abstract fun getStudentsDao(): StudentsDao

    abstract fun getAppActionsDao(): AppActionsDao
