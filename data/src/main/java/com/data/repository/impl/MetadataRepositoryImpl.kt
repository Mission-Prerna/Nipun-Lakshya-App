...
class MetadataRepositoryImpl @Inject constructor(
    ...
    override fun getLearningOutcomeForRefIdsOfCompetency(grade: Int): List<Competency> {
        return metadataDao.getLearningOutcomeForRefIdsOfCompetency(grade)
    }
    ...
    override fun getDistinctGrades(): List<Int> {
        return metadataDao.getDistinctGrades()
    }
