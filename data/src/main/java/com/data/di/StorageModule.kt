...
object StorageModule {
    ...
    @Singleton
    @Provides
    fun providesMentorPerformanceInsightsDao(database: NLDatabase) =
        database.getMentorPerformanceInsightsDao()
    ...
    @Singleton
    @Provides
    fun provideAppActionsDao(database: NLDatabase) = database.getAppActionsDao()
