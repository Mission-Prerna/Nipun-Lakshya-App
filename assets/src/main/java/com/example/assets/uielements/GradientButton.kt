        ...
        if (!isFilled) {
            ...
            canvas.drawRoundRect(
                RectF(
                    mStroke.toFloat(),
                    mStroke.toFloat(),
                    (width - mStroke).toFloat(),
                    (height - mStroke).toFloat() + 25f
                ),
