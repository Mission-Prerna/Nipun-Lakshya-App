...
public class WorkflowFragment2 extends WorkflowBaseFragment {


    public WorkflowFragment2(WorkflowModuleCallback callback) {
        super(callback);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView)view.findViewById(R.id.title_tv)).setText("Quml Module");
