...
class AssessmentExaminerHomeFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvSummaryLabel.setOnClickListener {
            ...
            customDialogFragment.show(requireActivity().supportFragmentManager, "absentStudentsDialog")
        }
    }
    ...
    private fun confirmLogoutWithSync() {
        LogoutUI.confirmLogoutWithSync(requireContext()) {
            viewModel.syncDataToServer(prefs, {
                ...
                Toast.makeText(requireContext(), R.string.error_generic_message, Toast.LENGTH_LONG)
                    .show()
            }
        }
    }
...
//        startActivity(Intent(context, AssessmentSetupActivity::class.java))
    ...
    companion object {
        fun newInstance(): AssessmentExaminerHomeFragment =
            AssessmentExaminerHomeFragment().withArgs {
