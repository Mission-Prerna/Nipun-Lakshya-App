...
public class AppPreferenceHelper implements PreferenceHelper {
    ...
    @Override
    public void prefFileCreationTime() {
        SharedPreferences.Editor editor = defaultPreferences.edit();
        if (!defaultPreferences.contains(PreferenceKeys.KEY_PREF_CREATION_TIME))
         editor.putLong(PreferenceKeys.KEY_PREF_CREATION_TIME, System.currentTimeMillis());
        editor.apply();
    }
