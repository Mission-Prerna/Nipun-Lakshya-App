...
private const val READ_ALONG_VIDEO_URL = "https://www.youtube.com/watch?v=tHyPLZjVsLo"

private const val READ_ALONG_PLAY_STORE_URL = "http://play.google.com/store/apps/details?id=com.google.android.apps.seekh"

private const val READ_ALONG_PACKAGE_NAME = "com.google.android.apps.seekh"
...
class ReadAlongDisclaimerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.youtubeView.setOnClickListener {
            ...
            intent.data = Uri.parse(READ_ALONG_VIDEO_URL)
            ...
            binding.proceedToAssessmentPlaystore.setOnClickListener {
                ...
                try {
                    ...
                    startActivity(
                        Intent(
                            Intent.ACTION_VIEW,
                            Uri.parse(READ_ALONG_PLAY_STORE_URL)
                        )
                    )
                }
            }
    ...
    private fun appInstalledOrNot(
        pm: PackageManager,
        uri: String? = READ_ALONG_PACKAGE_NAME
    ): Boolean {
        return try {
