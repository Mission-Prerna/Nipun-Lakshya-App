...
class ExaminerStudentSelectionActivity :
                    ...
                    override fun onLocationLatLongNull() {
                        ...
                        if (!locationCheckDuringAssessmentEnd) {
                            ...
                            ToastUtils.showShortToast(
                                ...
                                message = "School lat long is null!"
                            )
                        } else {
                            viewModel.updateOfflineStats(school?.udise!!, this@ExaminerStudentSelectionActivity)
                        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CHECK_SETTINGS) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                ToastUtils.showShortToast(this, getString(R.string.enable_location))
            }
        }
    }
    ...
    private fun setupRecyclerView() {
        ...
        studentAdapter = StudentAdapter(mutableListOf(), isExaminer = true, studentSharedViewModel = studentSharedViewModel)
