        ...
        protected final HashMap<String, Object> doInBackground(ArrayList<DriveListItem>... params) {
            ...
            for (int k = 0; k < fileItems.size(); k++) {
                ...
                try {
                    ...
                    results.put(fileItem.getName(), Collect1.getInstance().getAppContext().getResources().getString(R.string.success));
                    ...
                    if (mediaFileList != null) {
                        ...
                        for (com.google.api.services.drive.model.File mediaFile : mediaFileList) {
                            ...
                            results.put(filePath, Collect1.getInstance().getAppContext().getResources().getString(R.string.success));
                        }
                    }
                } catch (Exception e) {
                    Timber.e(e);
