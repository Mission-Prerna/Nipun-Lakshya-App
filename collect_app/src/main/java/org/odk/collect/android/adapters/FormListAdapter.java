...
public class FormListAdapter extends SimpleCursorAdapter {
    ...
    public FormListAdapter(
            ...
            OnItemClickListener mapButtonListener, String[] columnNames, int[] viewIds, String typeForms) {
        ...
        setViewBinder(new ViewBinder() {
            ...
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                ...
                if (columnName.equals(FormsColumns.DATE) || columnName.equals(FormsColumns.MAX_DATE)) {
                    String timestampText = FormListAdapter.this.getTimestampText(new Date(cursor.getLong(columnIndex)));
                    ...
                    if (version != null) {
                        versionIdText += FormListAdapter.this.getString(R.string.version_number, version);
                    }
                    if (Arrays.asList(columnNames).contains(FormsColumns.JR_FORM_ID)) {
                        ...
                        if (id != null) {
                            versionIdText += FormListAdapter.this.getString(R.string.id_number, id);
                        }
                    }
                    TextView v = (TextView) view;
                    v.setVisibility(View.GONE);
                    ...
                    view.setVisibility(xpath != null ? View.VISIBLE : View.GONE);
                     ...
                     if(cursor.getString(cursor.getColumnIndex(FormsColumns.DISPLAY_NAME)).contains("Meeting")) {
