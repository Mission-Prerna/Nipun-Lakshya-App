...
public class PropertyManager implements IPropertyManager {
    ...
    public PropertyManager reload() {
        try {
            ...
            String id = "DeviceID_not_present"; //Settings.Secure.getString(Collect1.getInstance().getAppContext().getContentResolver(), Settings.Secure.ANDROID_ID);
            putProperty(PROPMGR_DEVICE_ID,     idp.prefix,          id);
