...
public class WebCredentialsUtils {
    ...
    public String getServerSubmissionUrlPrefs() {
        return (String)  GeneralSharedPreferences.getInstance().get("odk_server_submission_url");
    }

    public String getServerUrlPrefs() {
       return (String) GeneralSharedPreferences.getInstance().get("odk_server_url");
    }
